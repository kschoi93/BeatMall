...
<div class="container">
	<div id="box"> 	
	<form method="post" name="boardEdit" id="boardEditFrm" action="noticeEditOk"> 
		<table>
			<tbody> 
				<tr class="tr_head">
					<th class="menu" >공지 번호</th>
					<td class="td" colspan="3" name="infonum" > ${vo.no} </td>
				</tr>
				<tr class="tr_head">
					<th class="menu">제목</th>
					<td  class="td"><input type="text" name="noticeTitle" id="noticeTitle" value="${vo.infoTitle}"/></td>
				</tr>
				<tr class="tr_head">
				...
				<tr>
					<td class="question_content" colspan="4">
						<textarea id="qmcontent" name="qmcontent" class="summernote" > ${vo.infocontent} </textarea>
					</td>	
				</tr>
			</tbody>
		</table>
